class SlackTrend < ActiveRecord::Base
  ...
  def get_data
    ...
    participation_total = 50 # Max score for rating participation (Based on Gini Coefficient)
    ...
    (1..3).each do |i|
      ...
      if num_messages_score >= num_message_threshhold  # Rates the total amount messages
        ...
        total_score += num_messages_score*(participation_total.to_f/num_message_threshhold)
      end
